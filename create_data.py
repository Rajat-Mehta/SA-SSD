...
if __name__ == '__main__':
    create_kitti_info_file('/raid/rajat/datasets/kitti/object_detection')
    create_reduced_point_cloud('/raid/rajat/datasets/kitti/object_detection')

    create_groundtruth_database(data_path='/raid/rajat/datasets/kitti/object_detection', \
                                info_path='/raid/rajat/datasets/kitti/object_detection/kitti_infos_trainval.pkl', \
                                db_info_save_path='/raid/rajat/datasets/kitti/object_detection/kitti_dbinfos_trainval.pkl')

    create_groundtruth_database(data_path='/raid/rajat/datasets/kitti/object_detection', info_path=None, db_info_save_path=None)    